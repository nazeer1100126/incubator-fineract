...
public class BusinessEventNotificationConstants {
    ...
    public static enum BUSINESS_EVENTS {
        LOAN_APPROVED("loan_approved"), LOAN_UNDO_APPROVAL("loan_undo_approval"), LOAN_UNDO_DISBURSAL("loan_undo_disbursal"), LOAN_UNDO_LASTDISBURSAL(
                ...
                "savings_activated"), SAVINGS_ADJUST_TRANSACTION("savings_adjust_transaction"), SAVINGS_APPLY_FEE("savings_apply_fee"), SAVINGS_CALCULATE_INTEREST(
                "savings_calculate_interest"), SAVINGS_CLOSE("savings_close"), SAVINGS_POST_INTEREST("savings_post_interest"), SAVINGS_REJECT(
                "savings_reject"), SAVINGS_DEPOSIT("savings_deposit"), SAVINGS_WITHDRAWAL("savings_withdrawal"), CLIENTS_ACCEPT_TRANSFER(
                "clients_accept_transfer"), CLIENTS_ACTIVATE("clients_activate"), CLIENTS_ASSIGN_STAFF("clients_assign_staff"), CLIENTS_CLOSE(
                "clients_close"), CLIENTS_CREATE("clients_create"), CLIENTS_DELETE("clients_delete"), CLIENTS_PROPOSE_TRANSFER(
